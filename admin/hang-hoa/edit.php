<div class="container mt-3">
    ...
    <br>
    <input class="form-control" type="text" value="<?=$item['ma_hh']?>" name="mahanghoa" placeholder="auto number" /><br>
    </div>
    <div class="col p-3 ">
    <label class="form-label">Tên hàng hóa: </label>
    <br>
    <input class="form-control" type="text" value="<?=$item['ten_hh']?>" name="tenhanghoa" /><br>
    </div>
    <div class="col p-3 ">
    <label class="form-label">Đơn giá: </label>
    <br>
    <input class="form-control" type="text" value="<?=$item['don_gia']?>" name="dongia" /><br>
    </div>
    </div>
    <div class="row">
    <div class="col p-3 ">
    ...
    <br>
    <input class="form-control" type="text" value="<?=$item['giam_gia']?>" name="giamgia" /><br>
    </div>
    <div class="col p-3 ">
...
?>
    ...
    <br>
    <input class="form-control" value="<?=$item['ngay_nhap']?>" type="date" name="ngaynhap" /><br>
    </div>
    <div class="col p-3 ">
