...
<div class="row">
  <div class="col-sm-6"><label class="form-label">Mã khách hàng: </label>
    <br>
    <input class="form-control" type="text" name="makhachhang" value="<?=$item['ma_kh']?>"/><br></div>
  <div class="col-sm-6"><label class="form-label">Họ và tên: </label>
    <br>
    <input class="form-control" type="text" name="hovaten" value="<?=$item['ho_ten']?>" /><br></div>
</div>

<div class="row">
  <div class="col-sm-6"><label class="form-label">Mật khẩu: </label>
    <br>
    <input class="form-control" type="text" name="matkhau" value="<?=$item['mat_khau']?>" /><br></div>
...
<div class="row">
  <div class="col-sm-6"><label class="form-label">Địa chỉ email: </label>
    <br>
    <input class="form-control" type="text" name="email" value="<?=$item['email']?>" /><br></div>
  <div class="col-sm-6"><label class="form-label">Hình ảnh: </label>
    <br>
    <input class="form-control" type="file" name="hinh" value="<?=$item['hinh']?>" /></div>
</div>
