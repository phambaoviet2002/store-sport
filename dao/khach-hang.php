<?php
    ...
    function khach_hang_update($ma_kh, $mat_khau, $ho_ten, $kich_hoat, $hinh, $email, $vai_tro){
        $sql = "UPDATE khach_hang SET ma_kh=?,mat_khau=?,ho_ten=?,kich_hoat=?,hinh=?,email=?,vai_tro=?
        WHERE ma_kh=?";
    ...
    function khach_hang_change_password($mat_khau2,$ma_kh) {
        $sql = "UPDATE khach_hang SET mat_khau=? WHERE ma_kh =?";
        return pdo_execute($sql, $mat_khau2,$ma_kh);
    }
